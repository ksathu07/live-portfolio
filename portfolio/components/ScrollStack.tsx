...
// Scroll-driven card stacking: cards pile up and lock at the top of the
// viewport as you scroll, each one slightly smaller and deeper in the stack.
// Ported from the cinematic-portfolio reference (same math, shared Lenis).
